...
module type S = sig
  ...
  val explicate : ?line_breaks:[`Unicode | `Traditional] -> ?block_splitting_threshold:int -> ?blend:(Tag.t -> Tag.t -> Tag.t) -> ?debug:bool -> ?override_source:Range.source -> (Tag.t * Range.t) list -> Tag.t t
